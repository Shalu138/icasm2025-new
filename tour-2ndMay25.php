...
<head>
    ...
    <link rel="canonical" href="https://icasm2025.com/tour.php">
    <title>
    ...
    <meta property="og:url" content="https://icasm2025.com/tour.php">
    ...
    <main class="main">
        ...
        <!-- SIA -->
        <section class="sia-section section-padding pt-0 position-relative">
            <div class="container">
        ...
        <div class="tour-section section-padding position-relative bg" id="changiTour">
            <div class="container">
                <div class="row align-items-center">
        ...
        <!-- Changi Tour -->
        <section class="sia-section section-padding position-relative changi-tour">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-7">
                        <div class="content-left">
