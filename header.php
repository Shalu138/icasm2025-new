      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container navbar-bg">
          <a class="navbar-brand" href="index.php">
            <img src="assets/img/logo/ICASM-2025-logo.png" alt="logo" />
          </a>
          ...
          <div class="collapse navbar-collapse" id="main_nav">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item dropdown">
                <a
                  class="nav-link dropdown-toggle"
                  href="javascript:void(0)"
                  data-bs-toggle="dropdown">Scientific Programme</a>
                <ul class="dropdown-menu fade-up">
                  <li>
                   ...
                   <li>
                    ...
                    Andre Allard Memorial<br> Lecture</a>
                  </li>
                  ...
                  <li>
                    <a class="dropdown-item" href="isos-symposium.php">
                      Sponsored Symposium - International SOS
                    </a>
                  </li>
                  <li>
              ...
              <li class="nav-item dropdown">
                <a
                  class="nav-link dropdown-toggle"
                  href="https://abstracts.icasm2025.com/" target="_blank"
                  data-bs-toggle="dropdown">Submit Abstract</a>
                <ul class="dropdown-menu fade-up">
                  <li>
                    <a class="dropdown-item" href="submit-abstract.php">
                      Submit your Abstract</a>
                  </li>
                  <li>
                    <a class="dropdown-item" href="https://abstracts.icasm2025.com/instructions.html" target="_blank">Guidelines</a>
                  </li>
                </ul>
              </li>
              ...
              <li class="nav-item dropdown">
                <a
                  class="nav-link dropdown-toggle"
                  href="javascript:void(0)"
                  data-bs-toggle="dropdown">Travel</a>
                <ul class="dropdown-menu fade-up">
                  <li>
                    <a class="dropdown-item" href="airport-transfer.php">
                    Airport Transfers</a>
                  </li>
                  <li>
            ...
            <div class="header-nav-right">
              <div class="header-btn">
                <a href="registration.php" class="theme-btn">Register Now<i class="far fa-arrow-right"></i></a>
              </div>
            </div>
          </div>
        </div>
